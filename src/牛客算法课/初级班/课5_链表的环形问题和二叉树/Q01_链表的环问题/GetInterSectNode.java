package 牛客算法课.初级班.课5_链表的环形问题和二叉树.Q01_链表的环问题;


import 牛客算法课.初级班.课4_链表.Q02_链表反转.Node;
...
public class GetInterSectNode {
    ...
    // 解决问题3：判断有环链表的相交,已知两个链表的入环结点loop1,loop2
    ...
    // 解决问题2(力扣160)：判断无环链表的相交，与力扣160同题
    ...
    // 解决问题1(力扣142):判断一个链表是否有环,有就返回第一个入环结点
