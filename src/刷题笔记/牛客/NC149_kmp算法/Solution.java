...
public class Solution {
    ...
    /**
     * 牛客149kmp:
     * 给你一个非空模板串S是匹配串，一个文本串T是原串，问匹配串S在原串T中出现了多少次
     * 输入：
     * "ababab","abababab"
     * 返回值：2
     */
    public int kmp(String S, String T) {
        ...
        int i1 = 0;
        int i2 = 0;
        // 改造1：next数组多算1位，记录整个匹配串的最长前后缀长度
        int[] next = getNext(s2);
        int res = 0;
    ...
    public static void main(String[] args) {
        ...
        // next数组：[-1, 0, 0, 1, 0, 1, 2, 3, 2]
        System.out.println("next数组：" + Arrays.toString(solution.getNext(T.toCharArray())));
    }
}
